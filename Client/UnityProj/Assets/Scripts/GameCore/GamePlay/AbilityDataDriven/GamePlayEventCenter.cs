...
namespace GamePlay.AbilityDataDriven
{
    public class GamePlayEventCenter
    {
        //public GamePlayEventCenter()
        //{
        //    // Event Center is arranged and triggered by (enum)ENUM_Event.
        //    foreach (ENUM_Event ee in Enum.GetValues(typeof(ENUM_Event)))
        //    {
        //        Events.Add(ee, new Dictionary<int, GamePlayEvent>());
        //        RemoveEvents.Add(ee, new Dictionary<int, GamePlayEvent>());
        //    }
        //}

        ///// <summary>
        ///// All events are stored in this Dict by (key)ENUM_Event
        ///// </summary>
        //private SortedDictionary<ENUM_Event, Dictionary<int, GamePlayEvent>> Events = new SortedDictionary<ENUM_Event, Dictionary<int, GamePlayEvent>>();

        ///// <summary>
        ///// Mecha, MechaComponent register their events
        ///// </summary>
        //public void RegisterEvent(GamePlayAbilityGroup abilityGroup)
        //{
        //    foreach (GamePlayAbility gpa in abilityGroup.Abilities)
        //    {
        //        RegisterEvent(gpa);
        //    }
        //}
        ...
        ///// <summary>
        ///// Register single GamePlayAbility
        ///// </summary>
        //public void RegisterEvent(GamePlayAbility gpa)
        //{
        //    foreach (GamePlayEvent e in gpa.Events)
        //    {
        //        Events[e.EventType].Add(e, e);
        //        RemoveEvents[see.M_ExecuteSetting.RemoveTriggerTime].Add(see.ID, see);
        //    }
        //}

        ///// <summary>
        ///// If Mecha, MechaComponent are removed from battle, just call this method to UnRegister all events of them
        ///// </summary>
        //public void UnRegisterEvent(GamePlayAbilityGroup abilityGroup)
        //{
        //    foreach (GamePlayAbility gpa in abilityGroup.Abilities)
        //    {
        //        UnRegisterEvent(gpa);
        ...
        ///// <summary>
        ///// Unregister single GamePlayAbility
        ///// </summary>
        //public void UnRegisterEvent(GamePlayAbility gpa)
        //{
