...
namespace ShootTextPro
{
    ...
    public class ShootTextProController : MonoBehaviour
    {
        ...
        {
            get { return shootTextCamera == null ? Camera.main : shootTextCamera; }
            set { shootTextCamera = value; }
        }

        [Header("渐隐曲线")] [SerializeField] private AnimationCurve shootTextCure = null;
        [Header("抛物线曲线")] [SerializeField] private AnimationCurve shootParabolaCure = null;

        [Header("最大等待弹射数量")] [SerializeField] private int MaxWaitCount = 20;
        [Header("超过此数量弹射加速")] [SerializeField] private int accelerateThresholdValue = 10;
        [Header("加速弹射速率因子")] [SerializeField] private float accelerateFactor = 2;
        ...
        [Header("远近缩放因子")] [SerializeField] private float shootTextScaleFactor = 0.6f;
        ...
        {
            get { return delayMoveTime; }
            set { delayMoveTime = value; }
        }
        ...
        [Header("字体动画类型")] public TextAnimationType textAnimationType;
        [Header("字体移动类型")] public TextMoveType textMoveType;
