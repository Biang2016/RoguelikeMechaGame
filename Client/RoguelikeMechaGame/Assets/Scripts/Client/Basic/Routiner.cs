...
namespace Client
{
    public class Routiner : MonoSingleton<Routiner>
    {
        ...
        protected void Update()
        {
            ...
            UpdateTimerRoutine();
            UpdateFrameRoutine();
            UpdateConditionCallBack();
            UpdateCountDownRoutine();
            UpdateGameLogic();
        }
        ...
        private void UpdateConditionCallBack()
        {
            foreach (ConditionalRoutine data in ConditionalRoutineList)
            {
                data.CheckTimeInterval -= Time.deltaTime;
        ...
        private void UpdateCountDownRoutine()
        {
            currentTimeCountDownInterval += Time.unscaledDeltaTime;
